...
from services.bot_eval_skill import get_skill_definition, SYSTEM_PROMPT_INJECTION, SYSTEM_PROMPT_INJECTION_EN, SKILL_VERSION
...
with open(prompt_en_path, 'w', encoding='utf-8') as f:
    f.write(SYSTEM_PROMPT_INJECTION_EN)
